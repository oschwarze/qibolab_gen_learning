...
from qibolab.instruments.emulator.pulse_simulator import PulseSimulator,FunctionPulseSimulator
...
simulation_config = {
	"simulation_engine_name": "Qutip_analytic",
...
def create(nlevel: int = 3):
	...
	pulse_simulator = FunctionPulseSimulator(simulation_config, model_config)
